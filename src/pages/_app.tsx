...
export default function App(props: ExtendedAppProps) {
  ...
  return (
    <Provider store={store}>
      <Head>
        <title>{`${themeConfig.templateName} - Shopping Online`}</title>
        <meta name='description' content={`${themeConfig.templateName} – Shopping Online`} />
                ...
                return (
                  <ThemeComponent settings={settings}>
                    <Guard authGuard={authGuard} guestGuard={guestGuard}>
                      <AclGuard permissions={permissions} aclAbilities={aclAbilities} guestGuard={guestGuard} authGuard={authGuard}>
